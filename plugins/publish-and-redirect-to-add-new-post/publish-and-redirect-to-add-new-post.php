...
function prn_post_submitbox_misc_actions_function()
{
	...
	<input type='button' id='prn_draft' name='submit-new' value='Guardar & agregar nuevo' class='button button-primary button-large prn_button'>
	<input type='button' id='prn_visit' name='submit-new' value='Publicar & visitar ahora' class='button button-primary button-large prn_button'>
	<input type='button' id='prn_publish' name='submit-new' value='Publicar & agregar nuevo' class='button button-primary button-large prn_button'>
	</div>";
}
